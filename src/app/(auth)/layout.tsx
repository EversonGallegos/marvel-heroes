  ...
  return (
        <main className={`w-full h-full bg-blue-800  ${epilogue.className} tracking-full`}>
          <div className="flex max-w-grid w-full h-full relative mx-auto">
            ...
            <div className="absolute left-[50%] translate-x-[-50%] lg:translate-x-0 lg:left-auto lg:right-0 lg:mx-[68px] top-[55%] translate-y-[-50%] bg-white rounded-[28px] py-12 px-9 max-w-[380px]">
              {children}
            </div>
          </div>
        </main>
